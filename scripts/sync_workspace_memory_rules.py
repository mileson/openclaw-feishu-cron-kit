...
from openclaw_feishu_cron_kit.memory_rules import infer_openclaw_state_dir, list_workspace_memory_paths, update_memory_file
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--workspace-glob", default="workspace-*")
...
def main() -> None:
    ...
    if args.workspace_dir:
        ...
        memory_paths = list_workspace_memory_paths(state_dir, workspace_glob=args.workspace_glob)
